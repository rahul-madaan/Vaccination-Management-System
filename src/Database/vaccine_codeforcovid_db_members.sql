...
CREATE TABLE `members` (
  ...
  `DOB` date NOT NULL,
  `Age` int,
  `Dose1Status` tinyint(1) DEFAULT '0',
  `Dose2Status` tinyint(1) DEFAULT '0',
  `Dose1CentreID` varchar(255) DEFAULT NULL,
  `Dose2CentreID` varchar(255) DEFAULT NULL,
  `Dose1Date` date DEFAULT NULL,
  `Dose2Date` int DEFAULT NULL,
  ...
  CONSTRAINT `members_login_users_PhoneNumber_fk` FOREIGN KEY (`PhoneNumber`) REFERENCES `login_users` (`PhoneNumber`)
) ENGINE=InnoDB AUTO_INCREMENT=1596034 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `members` VALUES (1596030,'9899266579','rahul','123456123456','2001-05-18',20,0,0,NULL,NULL,NULL,NULL),(1596033,'8929333770','jfsd','123456123457','2000-05-10',21,0,0,NULL,NULL,NULL,NULL);
