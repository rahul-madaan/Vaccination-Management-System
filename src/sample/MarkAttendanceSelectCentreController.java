...
public class MarkAttendanceSelectCentreController implements Initializable {
    ...
    @FXML
    private TableColumn<VaccineCentre,String> colMarkAttendance;
...
//we are now setting the name of columns for java to understand
            ...
            colMarkAttendance.setCellFactory(cellFactory);
    ...
    private void selectButtonClicked(ActionEvent event) throws IOException {
