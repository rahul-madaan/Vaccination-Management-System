...
public class PdfMaker{
    ...
    public static void makeCertificate(Member member) throws Exception {
...
//        Paragraph paragraph2 = new Paragraph(para2);
        ...
        Text BenfName = new Text("Mrityunjay Singh");
        Text ag = new Text("20");
        Text gndr = new Text("Male");
        Text idVerf = new Text("ID verified");
        Text uniqHealthID = new Text("53-6002-7234-2703");
        Text BenfReffID = new Text("46223448781760");
        Text VaccnName = new Text("COVISHIELD");
        Text DateDose = new Text("22 May 2021");
        Text nextDose = new Text("14 Aug 2021");
        Text vaccnBy = new Text("Dr Arun");
        Text vaccnAt = new Text("HCL TECH, Gautam Buddha Nagar, Uttar Pradesh");
